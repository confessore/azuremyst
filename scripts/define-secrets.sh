...
read -p "please enter the stripe public key: " stripePublicKey
read -p "please enter the stripe secret key: " stripeSecretKey
...
echo "$stripePublicKey" > stripe-publickey
echo "$stripeSecretKey" > stripe-secretkey
